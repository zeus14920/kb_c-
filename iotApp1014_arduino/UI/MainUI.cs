...
namespace iotApp1005
{
    ...
    public partial class MainUI : MaterialForm
    {
        ...
        {
            string[] dataArr = (string[])args;
            string time = string.Empty;
            string temp1 = string.Empty;
            string temp2 = string.Empty;
            string humi1 = string.Empty;
            string humi2 = string.Empty;
            for (int i = 0; i < dataArr.Length; i++)
            {
                if (dataArr[i] != null)
                {
                    time = DateTime.Now.ToString("yyyy년MM월dd일 HH:mm:ss");
                    temp1 = Convert.ToString(dataArr[(int)DATA_TYPE.TEMP]);
                    humi1 = Convert.ToString(dataArr[(int)DATA_TYPE.HUMI]);
                    temp2 = temp[r.Next(10)];
                    humi2 = humi[r.Next(10)];
                }
                else
                {
            ...
            string temp1 = Convert.ToString(dataArr[(int)DATA_TYPE.TEMP]);
            string humi1 = Convert.ToString(dataArr[(int)DATA_TYPE.HUMI]);
